 ...
 * 获取的数据分页处理返回
 */
public class ResultPageList<E> implements Serializable {
    ...
    public ResultPageList(Collection<? extends E> c) {
        this.pageIndex = 1;
        this.totalPageCount = 0;
        this.total = 0;
        this.pageSize = 10;
    ...
    public ResultPageList(Collection<? extends E> c, Pagination pagination) {
        this(c);
    ...
    public <T> ResultPageList<T> toViewPaged(Class<T> entityClass) {
        ResultPageList<T> result = new ResultPageList();
